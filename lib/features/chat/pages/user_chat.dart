...
class _ConvoState extends State<Convo> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
            create: (context) => BackgroundProvider(backgroundPath: defaultBackground, chatfont: defaultFont),
      child: Builder(
        builder: (context) {
          return Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: Row(
                    children: <Widget>[
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context_1) {
                            return ChangeNotifierProvider.value(value: Provider.of<BackgroundProvider>(context),child: ChatSettings());
                          }) );
                        },
                        child: const Icon(
                          Icons.settings,
                ...
                body: Consumer<BackgroundProvider>(
                  builder: (context,provider,child) {
                    ...
                    image: DecorationImage(image: AssetImage(provider.backgroundPath ?? defaultBackground),fit: BoxFit.fill)
              ),
